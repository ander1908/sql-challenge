...
--Spell things correctly and you will have a better time
...
--we need dept_emp, employees, departments
select dept_emp.emp_no, employees.last_name, employees.first_name, departments.dept_name
from dept_emp
-- join on fk emp_no
inner join employees
...
-- capitalization is necessary exact matches needed for where
...
inner join departments
on dept_emp.dept_no = departments.dept_no
--where in multiple https://www.w3schools.com/sql/trysql.asp?filename=trysql_op_in
where departments.dept_name in ('Sales', 'Development');
------------------------------------------------------------------------------------------------------
-- 8. In descending order, list the frequency count of employee last names, i.e., how many employees share each last name.
--we need employees
--https://www.w3schools.com/sql/sql_count_avg_sum.asp
select employees.last_name, count(employees.last_name) as "LastName Frequency"
from employees
--ERROR:  column "employees.last_name" must appear in the GROUP BY clause or be used in an aggregate function
group by employees.last_name
-- descending order https://www.w3schools.com/sql/sql_orderby.asp
order by "LastName Frequency";
